...
const steps: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Bản đồ mở ở chế độ toàn tỉnh Lâm Đồng. Chạm ranh giới hoặc chọn tên xã/phường bên dưới ô tìm kiếm để mở danh bạ đúng địa bàn.',
    points: ['Nút “Toàn tỉnh” đưa bạn về tất cả ranh giới', 'Nút định vị chọn địa bàn theo vị trí thực của bạn'],
